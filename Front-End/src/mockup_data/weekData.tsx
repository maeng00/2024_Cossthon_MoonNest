  ...
  return [
    {
      ...
      end_date: "2024-12-23",
      week_day: [
        { name: "월", Life: 4.5, Work: 5.5, Exercise: 50, Sleep: 34 }, // Add Exercise data
        { name: "화", Life: 3.5, Work: 6.5, Exercise: 47, Sleep: 32 },
        { name: "수", Life: 4, Work: 6, Exercise: 62, Sleep: 45 },
        { name: "목", Life: 5, Work: 5, Exercise: 40, Sleep: 35 },
        { name: "금", Life: 6, Work: 4, Exercise: 63, Sleep: 29 },
        { name: "토", Life: 5, Work: 5, Exercise: 50, Sleep: 36 },
        { name: "일", Life: 5, Work: 5, Exercise: 46, Sleep: 26 },
      ],
    },
    {
